...
On Rowy, you can collaborate with your team members using fine granular permission controls. 
...
'ADMIN' users can invite their team members/other users to gain access to data on Rowy. Access can be give at table level or field level
using "User Management" section or Firebase Admin SDK.
...
To use User Management, make sure you have setup Rowy via [Option 1](https://docs.rowy.io/setup/install) guided process. If prompted, setup Rowy Run in the Rowy UI.
If you are using the manual installation process, follow the instructions
in the Firebase Admin SDK tab above.
