...
[Read more about custom claims&nbsp;↗️](https://firebase.google.com/docs/auth/admin/custom-claims)  
[Read more about Firestore Security Rules&nbsp;↗️](https://firebase.google.com/docs/firestore/security/rules-structure)
...
[Firebase Console&nbsp;↗️](https://console.firebase.google.com/u/0/project/_/firestore/rules)

If you’re not familiar with writing Firestore Security Rules, read the
[Firebase guide&nbsp;↗️](https://firebase.google.com/docs/firestore/security/rules-structure)
...
[Read more about how to write rules&nbsp;↗️](https://firebase.google.com/docs/firestore/security/rules-structure)
