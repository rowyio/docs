...
You can set up Rowy using our guided setup process. It will take less than 2
minutes to complete if you already have an existing Firebase project set up.
