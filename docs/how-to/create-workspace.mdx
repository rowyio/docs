...
- Currently, when you sign up for Rowy - you get one Free workspace in the BASE free plan that can have one project connected.
If you would like to connect to multiple projects, then you need to upgrade the workspace to PRO plan.
- Also, if you would like more workspace than the default free workspace, then each of the new workspace needs to be in the PRO paid plan as well.
- Full details of the Rowy pricing is available here: [https://rowy.io/pricing](https://rowy.io/pricing)
