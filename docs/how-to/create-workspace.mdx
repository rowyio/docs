...
You can easily [add your team members](how-to/roles) to the workspace and manage their access to the projects.
...
- Currently, Rowy supports only one workspace in the BASE free plan. Support for multiple projects is under the PRO plan.
