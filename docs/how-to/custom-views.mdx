...
<img 
  src={require("./assets/hiding-cols.png").default}
  alt="Hiding and unhiding columns"
/>

### Lock Columns
The **Lock Column** option of the table view restricts any sort of data manipulation for the specified column.

The Lock Column feature can be best utilized for hindering unauthorized access to valuable data while sharing.

![Screen recording displaying lock table feature](./assets/locking-cols.gif)

### Multiple table views for the same collection
**Multiple table views for the same collection** can be implemented to create separate views for the same data collection. These Table views are distinguished with the use of unique Table IDs.

Users can customize the table and column views to meet the requirements of different team members.
<Video controls url="https://youtu.be/4Y60tNBdLv4" />