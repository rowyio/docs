...
3. The user can then either create a new project or connect to an existing project using the dropdown.
4. Enable the **Firestore Services** and the **Firebase Authentication Service** by following the steps prompted.
