---
id: spotify-wrapped
title: Dynamically generate images from Figma - with Firestore data 
slug: /templates/spotify-wrapped
---

import Video from "../../src/components/Video.js";
import Gist from "react-gist";

Build your own Spotify Wrapped for your app with your user data. Go from a Figma  
exported as SVG to auto generate images injected with your user's data. This can be great tool for 
creating engagement for your app on social media, image sharable user images such as Spotify wrapped, wordle scorecard, strava stats etc. 
With Rowy, you can build this in just 10 minutes.

<Video url="https://youtu.be/nA4tj1NT3ZM" />
...
<div
  dangerouslySetInnerHTML={{
    __html:
      "<iframe src='https://demo.rowy.io/table/wordgameWrapped' width='100%' height='500px'/>",
  }}
/>
