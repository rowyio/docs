...
Now, we need to grant the permissions to the app. Navigate to the **Projects & Apps** section in the sidebar. Click on the App name. Scroll down to the **User authentication settings**