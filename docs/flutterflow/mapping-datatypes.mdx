...
| **Photo Path**: To store the URL of the uploaded image. | <UrlIcon /> <DerivativeIcon /> | **URL** or **Derivative**: Unvalidated Web address or a value derived from the rest of the row’s values. *To know how, refer the [Displaying Images page](integrations/flutterflow/displaying-images).* |
| **Video Path**: To store the URL of the uploaded video. | <UrlIcon /> <DerivativeIcon /> | **URL** or **Derivative**: Unvalidated Web address or a value derived from the rest of the row’s values. *To know how, refer the [Displaying Images page](integrations/flutterflow/displaying-images).* |
| **Audio Path**: To store the URL of the uploaded audio. | <UrlIcon /> <DerivativeIcon /> | **URL** or **Derivative**: Unvalidated Web address or a value derived from the rest of the row’s values. *To know how, refer the [Displaying Images page](integrations/flutterflow/displaying-images).* |
| **Boolean**: To store either a true or false value. | <CheckboxIcon /> | **Toggle**: True/false value. Default: false. |
| **Timestamp**: To store date and time value. | <DateTimeIcon /> <DerivativeIcon /> | **Date/Time** or **Derivative**: Formatted date & time or a value derived from the rest of the row’s values. *To know how, refer the [Displaying Timestamps page](integrations/flutterflow/displaying-timestamps).* |
