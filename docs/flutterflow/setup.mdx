...
To build an end-to-end full stack application, we need to integrate both frontend and backend. 
The client uses the frontend of the application to communicate with the backend logic.
...
## Setting up Rowy with Firebase

The Rowy setup is super quick and simple. Follow the steps below, or watch this simple video to get started.

Go to [Rowy](https://rowy.app/) and **Sign Up** if haven’t already. If you already have a Rowy Account, click on **Sign In**.

<Video controls url="https://youtu.be/7Vc-ZJDNYbM" />

### Creating a Workspace

To create a workspace, follow the steps below, or [visit our docs](https://docs.rowy.io/how-to/create-project):
...
:::info  Multiple Workspaces
Currently, Rowy supports only one workspace in the **BASE** free plan. Support for multiple projects is under the **PRO** plan. You can customize and manage your workspace in the **Workspace Settings** page.
:::
...
:::info  Other Database Support
Currently, Rowy supports only Firestore as a data source. **PostgreSQL** and **MySQL** will be supported in the future versions.
:::