...
## Step 1: Enable search in Project settings
...
☑️ Go to the [MeiliSearch Developer Portal](https://cloud.meilisearch.com/projects) and sign up if haven't already. They have a generous free tier for their cloud service.
