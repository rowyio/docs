...
2. Alternatively, you can also access the Cloud Logs by accessing the **Column Settings** of any cloud function based column. Click on the `logs` option to access the Cloud Logs for that function.
