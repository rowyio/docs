...
3. Add the **Airtable API Key** and the **Table URL**. You can find how to generate the [API key](/import-export-data/import-airtable#retrieving-the-airtable-api-key) and the [Table URL](/import-export-data/import-airtable#obtaining-the-airtable-table-url) in the sections below.
