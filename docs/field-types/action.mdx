...
⚠️ Make sure to add your sendrid API key to [Secret Manager](https://console.cloud.google.com/security/secret-manager/), and [verify](https://docs.sendgrid.com/for-developers/sending-email/sender-identity) the sender email address on Sengrid.
