...
By navigating to the side menu, the user can check out all the details of the current row including the 
Firestore path where the upload has been stored.

Using this link, the user can access the Firebase Firestore datapoint for a specific file. This is useful for
utilizing the Firebase Storage API.