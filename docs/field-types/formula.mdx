...
**Dataset:** Table contains list of students and their scores in different subjects.
Let's see how we can create simple formulas for calculating their average, grade etc.
...
### Check fo greater than, less than or equal to
