...
| <ConnectTableIcon />   | **Connect Table** <br/> (Alpha)   | Connects to an existing table to fetch a snapshot of values from a row. Requires Algolia integration. [See guide](./connect-table.md)                                                                          | <code>{<br/>&nbsp;&nbsp;docPath:&nbsp;string;<br/>&nbsp;&nbsp;snapshot:<br/>&nbsp;&nbsp;&nbsp;&nbsp;[Record<string,&nbsp;any>](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeystype);<br/>}[]</code> |
...
| <DerivativeIcon /> | **Derivative** | Value derived from the rest of the row’s values. Displayed using any other field type. Requires Cloud Function set up.        | `any`          |
| <AggregateIcon />  | **Aggregate**  | Value aggregated from a specified sub-table of the row. Displayed using any other field type. Requires Cloud Function set up. | `any`          |
