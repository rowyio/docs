...
Connector columns allow you to excute any backend code and return a list of options to your user.
The options could be static list, list of documents from a collection, or a list of documents from a query to third party API.
